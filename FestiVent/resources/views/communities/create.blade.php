  ...
  <body>
        ...
        <div id="content" class="p-4 p-md-5 pt-5  ml-5">
            ...
            <div class="container-md mt-5 border rounded-3 p-4 shadow p-3 mb-5 bg-body-tertiary rounded">
                <form class="row g-3" method="POST" action="{{ route('communities.store') }}" enctype="multipart/form-data">
                    @csrf
                    <h3 class="mb-2">Community Data</h3>
                    <div class="col-12">
                      <label for="nama_community" class="form-label">Nama Komunitas</label>
                      <input type="text" class="form-control border" id="nama_community" name="nama_community" required>
                    </div>
                    <div class="col-md-6">
                      <label for="asal" class="form-label">Asal Kota</label>
                      <input type="text" class="form-control border" id="asal" name="asal" required>
                    </div>
                    <div class="col-md-6">
                      <label for="kategori" class="form-label">Kategori</label>
                      <select id="kategori" name="kategori" class="form-select border" required>
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control border" id="deskripsi" name="deskripsi" required>
                    </div>
                    <div class="col-md-6">
                        <label for="gambar" class="form-label">Gambar/Logo</label>
                        <input type="file" class="form-control border" id="gambar" name="gambar" required>
                      </div>
                    <div class="col-12">
